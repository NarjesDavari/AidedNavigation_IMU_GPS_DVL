...
Include_HinfVB = Simulation.select_adaptive.HinfVB_adaptive;
gama2 = Simulation.parameter_HinfVB.gama2;%% parameter of H-infinity
...
fs_heading=1/mean(diff(Simulation.Input.Measurements.Heading(:,1)));
...
%                             hdng_Time  = Simulation.Input.Measurements.Heading(Simulation.Input.Measurements.hdng_Counter,1);
                        ...
                        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                        [Simulation,flag_Qadapt] = ESKF(Simulation,I,Selection_Param,C_DVL_IMU,Include_R_adaptive,Include_Q_adaptive,Include_VB_adaptive, Include_IF_VB_adaptive,Include_HinfVB,gama2,flag_Qadapt,Misalignment_IMU_phins,ave_sample,calib_sample,SF,dt,fs_auxiliarySensor);
...
%                 end
%                    [ Simulation] = Navigate_Error_wayPoint( Simulation , ave_sample );
