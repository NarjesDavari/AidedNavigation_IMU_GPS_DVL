...
x_traning_set=Real_Measurement.DVL(:,2);
...
% x_traning_set=Real_Measurement.DVL_2(:,2); %%(6000:9500,2); %%(2200:4700,2); %%(3400:3800,2); %% 
% x_testing_set = Real_Measurement.DVL_2(:,2); %%(6000:9500,2);
...
%             y1 = log(1+exp(W_ih_new .* I_traning_set + b_ih_new + W_hh_new .* h));
        ...
        recon_error (i,kk)=u(end)-u_hat(end);
         recon_error_sum (i,kk)=norm(u(end)-u_hat(end));
