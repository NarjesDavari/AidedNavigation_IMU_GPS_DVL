...
%             quaternion = convert_Euler2Quaternion (Simulation.Output.INS.X_INS (1,7:9)); 
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
            Simulation.Input.InitialParam.InitialQuat  = Simulation.Output.INS.X_INS (1,7:10);
            Cbn_INS                                    = InCBN_quater(Simulation.Output.INS.X_INS (1,7:10));
...
%             Simulation.Output.Alignment.time         = zeros(Dlength-ave_sample +1 ,1);
            ...
            Simulation.Output.Alignment.theta(1,1)       = Simulation.Output.INS.X_INS_BEuler(1,8);
            Simulation.Output.Alignment.phi(1,1)         = Simulation.Output.INS.X_INS_BEuler(1,7);
            Simulation.Output.Alignment.ave_theta(1,1)   = Simulation.Output.INS.X_INS_BEuler(1,8);
            Simulation.Output.Alignment.ave_phi(1,1)     = Simulation.Output.INS.X_INS_BEuler(1,7);           
%             Simulation.Output.Alignment.time         = Simulation.Input.Measurements.IMU(1,1);
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%          
                       
%              Simulation.Output.ESKF.dX = zeros(Dlength-ave_sample+1 ,16);
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            Simulation.Output.ESKF.O_corrected      = zeros(Dlength-ave_sample +1 ,size(Simulation.Output.INS.X_INS(1,:),2));
            Simulation.Output.ESKF.O_corrected(1,:) = Simulation.Output.INS.X_INS(1,1:16);
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%             Simulation.Output.Kalman_mtx.Q_diag=zeros(Dlength-ave_sample,size(dX1,1));
            ...
            x1=Simulation.Output.INS.X_INS(1,1:10);
            C1=Simulation.Output.INS.Cbn(:,:,1);
            [Simulation,flag_Qadapt]=AQ_calcul(x1,C1,Simulation,fs,1,Include_Q_adaptive,0,Simulation.Output.INS.fnn(1,:), ave_W);
...
%             Simulation.Output.User_Def_Sim.Kalman_mtx.P = diag([1,0.01,0.01,0.01,0.018773,0.018773,0.018773]);
            ...
            Simulation.Output.Kalman_mtx.P(10,10) =  1e-6*b43;
            
            Simulation.Output.Kalman_mtx.P(11,11) = 1e-6*b5;
            Simulation.Output.Kalman_mtx.P(12,12) = 1e-6*b5;
            Simulation.Output.Kalman_mtx.P(13,13) =  1e-6*b5;
            
            Simulation.Output.Kalman_mtx.P(14,14) =  1e-6*b61;
            Simulation.Output.Kalman_mtx.P(15,15) =  1e-6*b62;
%             Simulation.Output.Kalman_mtx.P(16,16) =  1e-6*b63;
            Simulation.Output.Kalman_mtx.P0_Bias=[Simulation.Output.Kalman_mtx.P(10,10) Simulation.Output.Kalman_mtx.P(11,11) Simulation.Output.Kalman_mtx.P(12,12)...
               Simulation.Output.Kalman_mtx.P(13,13) Simulation.Output.Kalman_mtx.P(14,14)  Simulation.Output.Kalman_mtx.P(15,15)]; %%  Simulation.Output.Kalman_mtx.P(16,16)
...
%             Simulation.Output.Kalman_mtx.R_adaptive.R_rollpitch = zeros(length(Simulation.Input.Measurements.RollPitch),2);
            Simulation.Output.Kalman_mtx.R_adaptive.R_Heading = zeros(length(Simulation.Input.Measurements.Compass),1);
