...
function [Simulation,flag_Qadapt] = ESKF( Simulation,I,Selection_Param,C_DVL_IMU,Include_R_adaptive,Include_Q_adaptive,Include_VB_adaptive,Include_IF_VB_adaptive,flag_Qadapt,Misalignment_IMU_phins,ave_sample,calib_sample,SF,dt,fs_auxiliarySensor)
...
if Include_IF_VB_adaptive
    ...
    [Simulation,dX,P,alpha,beta] = eskf_predict(Simulation,I,ave_sample);
end
if Simulation.parameter_outlierDetDVL.active==1
    [Simulation,V,alphaN,betaN ] = Correction_Param_outlierDVL(Simulation,Selection_Param,SF,I,C_DVL_IMU,P,Misalignment_IMU_phins,ave_sample,calib_sample,alpha,beta,dt);
        ...
        if (~isempty (Simulation.Output.Kalman_mtx.H))
           ...
           [Simulation,dX,P,flag_Qadapt,alpha,beta]=eskf_update_select(Simulation,dX,P,dz,H,H2,M,R,I,V,Selection_Param,Include_R_adaptive,Include_Q_adaptive,Include_VB_adaptive, Include_IF_VB_adaptive,alpha,beta,alphaN,betaN);          
