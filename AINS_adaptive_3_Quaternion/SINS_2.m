...
function [Simulation,fb,Wib_b]=SINS_2(Simulation , I , dt ,func_f, fc_f_RP , fc_f_accel , fc_f_gyro , filtered_accel , filtered_gyro ,ave_sample,muu,coeff_final,include_MA)
...
%     dt=1/fs;
            ...
            if include_MA==1 && I>=ave_sample+4
                ...
                bias=Simulation.Output.INS.X_INS(I-ave_sample-3:I-ave_sample,11:16);
            ...
            Simulation.Output.INS.norm.Accel_norm(I- ave_sample + 1,1) = abs(norm(filtered_RP) - norm(gl));%fb
            Simulation.Output.INS.norm.Gyro_norm (I- ave_sample + 1,1) = norm(filtered_Gyro);%Wib_b               
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
             X_ = Simulation.Output.INS.X_INS(I - ave_sample,1:10);
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                elseif ~filtered_accel && filtered_gyro
                    [fb,fb_,Wib_b,Wib_b_]=correction_Bias(Simulation,fb,fb_,filtered_Gyro,filtered_Gyro_,I,ave_sample);
                elseif filtered_accel && filtered_gyro
...
%         end 
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            INS_Quater_I = [X(7),X(8),X(9),X(10)];
            Simulation.Output.INS.Cbn(:,:,I - ave_sample + 1) = InCBN_quater(INS_Quater_I);%corrected transformation matrix             
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            Simulation.Output.INS.X_INS(I - ave_sample + 1,:) = [ X , Simulation.Output.INS.X_INS(I - ave_sample,11:16)];
            Simulation.Output.INS.fnn(I - ave_sample ,:)   = fnn;
            Simulation.Output.INS.Wnb_b(I - ave_sample ,:)   = Wnb_b;
